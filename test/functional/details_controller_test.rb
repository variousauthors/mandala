...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { content: @detail.content, keyword: @detail.keyword, phrase_id: @detail.phrase_id }
    end
  ...
  test "should update detail" do
    put :update, id: @detail, detail: { content: @detail.content, keyword: @detail.keyword, phrase_id: @detail.phrase_id }
    assert_redirected_to detail_path(assigns(:detail))
  end
